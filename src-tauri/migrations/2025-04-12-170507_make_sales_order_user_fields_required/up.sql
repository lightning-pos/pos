-- Make created_by and updated_by required in sales_orders table
PRAGMA foreign_keys = OFF;

-- Create a new table with the required fields
CREATE TABLE sales_orders_new (
    ...
    created_by TEXT NOT NULL, -- Changed back to required
    updated_by TEXT NOT NULL, -- Changed back to required
    discount_id TEXT,
...
-- This will fail if there are any NULL values in created_by or updated_by
