-- Fix foreign key constraints for sales_orders table
-- First, drop the existing foreign key constraints
PRAGMA foreign_keys = OFF;

-- Modify the sales_orders table to make created_by and updated_by nullable
CREATE TABLE sales_orders_new (
    ...
    created_by TEXT, -- Changed to nullable
    updated_by TEXT, -- Changed to nullable
    discount_id TEXT,
